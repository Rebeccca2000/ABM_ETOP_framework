...
DB_CONNECTION_STRING = 'sqlite:///service_provider_database_03.db'
SIMULATION_STEPS = 720
# #####################################Control for commuters#################################
num_commuters = 100
income_weights = [0.3, 0.5, 0.2]# income_levels = ['low', 'middle', 'high']
health_weights = [0.9, 0.1]# health_statuses = ['good', 'poor']
payment_weights = [0.9, 0.1] # payment_schemes = ['PAYG', 'subscription']
...
public_price_table = {
    'train': {'on_peak': 1.5, 'off_peak': 1.1},
    'bus': {'on_peak': 0.8, 'off_peak': 0.6}
}

UberLike1_cpacity = 65
UberLike1_price = 11

UberLike2_cpacity = 75
UberLike2_price = 11.5


BikeShare1_capacity = 40
BikeShare1_price = 2.5


BikeShare2_capacity = 50
BikeShare2_price = 2.5
...
transfers = {
    ('B42', 'B55'): 2, ('B43', 'T5-5'): 1, ('T1-6', 'T5-4'): 0, ('T1-3', 'B28'): 1, ('T1-1', 'B21'): 1,
    ('B49', 'T1-1'): 1, ('T2-1', 'B22'): 1, ('T5-1', 'B29'): 1, ('T5-3', 'B36'): 1, ('T5-5', 'B43'): 1,
    ('B81', 'T5-6'): 1, ('T1-7', 'B62'): 1, ('T4-5', 'B60'): 1, ('T4-5', 'B37'): 1, ('T4-4', 'B59'): 1,('T4-3', 'B58'): 1, ('T4-3', 'B30'): 1, ('T2-2', 'T4-2'): 0, ('T4-2', 'B57'): 1, ('T2-2', 'B57'): 1, ('T4-1', 'B56'): 1,('T4-1', 'B23'): 1,
    ('T3-1', 'B24'): 1, ('T2-3', 'T3-3'): 1, ('T2-3', 'B31'): 1, ('T3-3', 'B31'): 1, ('T3-5', 'B38'): 1,
    ('T6-1', 'B63'): 1, ('T6-1', 'B25'): 1, ('T6-2', 'B64'): 1, ('T6-3', 'B65'): 1, ('T6-3', 'B65'): 1, ('T2-4', 'T6-4'): 1, ('T2-4', 'B66'): 1,('T6-4', 'B66'): 1,('T6-5', 'B67'): 1,('T6-5', 'B39'): 1,('T3-6', 'B68'): 1,('T4-7', 'B69'): 1,('B46', 'B69'): 1, ('T1-9', 'T5-8'): 1,('T1-9', 'B90'): 1, ('B90', 'T5-8'): 1, 
    ('T7-1', 'B26'): 2, ('T7-3', 'B33'): 2, ('T2-5','T7-5'): 0, ('T2-5','B40'): 1, ('B40','T7-5'): 1, ('B47','T3-7'): 2,
    ('B27', 'B70'): 2, ('B34', 'B72'): 1, ('B41', 'B74'): 2, ('T2-6', 'B75'): 1, ('T6-7', 'B48'): 2, ('T3-8', 'B83'): 1, ('T4-9', 'B91'): 1,
    ('B79', 'T2-7'): 2, ('T7-6', 'B78'): 1, ('T6-7', 'B48'): 2, ('T7-8', 'B87'): 1, ('T2-9', 'T7-9'): 0,
     ('B55', 'B42'): 2, ('T5-5', 'B43'): 1, ('T5-4', 'T1-6'): 0, ('B28', 'T1-3'): 1, ('B21', 'T1-1'): 1,
    ('T1-1', 'B49'): 1, ('B22', 'T2-1'): 1, ('B29', 'T5-1'): 1, ('B36', 'T5-3'): 1, ('B43', 'T5-5'): 1,
    ('T5-6', 'B81'): 1, ('B62', 'T1-7'): 1, ('B60', 'T4-5'): 1, ('B37', 'T4-5'): 1, ('B59', 'T4-4'): 1, ('B58', 'T4-3'): 1, ('B30', 'T4-3'): 1, ('T4-2', 'T2-2'): 0, ('B57', 'T4-2'): 1, ('B57', 'T2-2'): 1, ('B56', 'T4-1'): 1, ('B23', 'T4-1'): 1,
    ('B24', 'T3-1'): 1, ('T3-3', 'T2-3'): 1, ('B31', 'T2-3'): 1, ('B31', 'T3-3'): 1, ('B38', 'T3-5'): 1,
    ('B63', 'T6-1'): 1, ('B25', 'T6-1'): 1, ('B64', 'T6-2'): 1, ('B65', 'T6-3'): 1, ('B65', 'T6-3'): 1, ('T6-4', 'T2-4'): 1, ('B66', 'T2-4'): 1, ('B66', 'T6-4'): 1, ('B67', 'T6-5'): 1, ('B39', 'T6-5'): 1, ('B68', 'T3-6'): 1, ('B69', 'T4-7'): 1, ('B69', 'B46'): 1, ('T5-8', 'T1-9'): 1, ('B90', 'T1-9'): 1, ('T5-8', 'B90'): 1,
    ('B26', 'T7-1'): 2, ('B33', 'T7-3'): 2, ('T7-5', 'T2-5'): 0, ('B40', 'T2-5'): 1, ('T7-5', 'B40'): 1, ('T3-7', 'B47'): 2,
    ('B70', 'B27'): 2, ('B72', 'B34'): 1, ('B74', 'B41'): 2, ('B75', 'T2-6'): 1, ('B48', 'T6-7'): 2, ('B83', 'T3-8'): 1, ('B91', 'T4-9'): 1,
    ('T2-7', 'B79'): 2, ('B78', 'T7-6'): 1, ('B48', 'T6-7'): 2, ('B87', 'T7-8'): 1, ('T7-9', 'T2-9'): 0,
}
